  ...
  if(action!=null&&action.equalsIgnoreCase("logout")){
		...
		response.sendRedirect(urlCa+"/logout.jsp");	
      	...
      	response.addCookie(cookie);	 
				...
				Cookie cookie2 = new Cookie("tloginName", null);  
      	cookie2.setMaxAge(0);  
     		cookie2.setPath("/");	
		...
		try {
			...
			if (http.getResponseCode() == 200) {
				...
				try {
					...
					if(root.element("code").getTextTrim().equalsIgnoreCase("100")){
						...
						Element tuser = eParam.element("tuser");
						
						Element eUserId = eCsuser.element("userId");
						Element eLoginName = tuser.element("loginName");
	       ...
	       /*具体cookie的存储模式需要客户端自行处理*/
						...
						saveCookie(response,"tloginName",eLoginName.getTextTrim());				
