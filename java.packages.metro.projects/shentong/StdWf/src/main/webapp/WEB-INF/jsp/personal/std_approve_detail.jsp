                            ...
                            <form id="form">
                           	  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_2">
                                  ...
                                  <tr>
                                    ...
                                    <td>${stdApprove.stdName}</td>
                                    <td class="lableTd t_r">标准编号</td>
                                     <td>${stdApprove.stdNo}</td>
                                  </tr>
                                  <tr>
                                    <td class="lableTd t_r">标准化员</td>
                                    <td>${stdApprove.cUser.name} 
                                     </td>
                                    <td class="lableTd t_r">申报部门</td>
                                    <td>${stdApprove.applyDept.name}
									</td>
                                  </tr>
                                  <tr>
                                    <td class="lableTd t_r">申报时间</td>
                                     <td>${stdApprove.applyDate}</td>
                                    <td class="lableTd t_r">立项编号</td>
                                    <td>${stdApprove.projectNo}</td>                                     
                                  </tr>
                                  <tr>
                                    <td class="lableTd t_r">标准功能</td>
                                    <td>
										${stdApprove.stdFun.name}
									</td>
                                    <td class="lableTd t_r">标准大类</td>
                                    <td>
										${stdApprove.stdMajorType.name}
									</td>
                                  </tr>         
                                  <tr>
                                    <td class="lableTd t_r">标准小类</td>
                                    <td>
										${stdApprove.stdMinorType.name}
									</td>
                                    <td class="lableTd t_r">标准备注项</td>
                                    <td>
										${stdApprove.stdRemarkItem.name}
									</td>
                                  </tr>              
                                  <tr>
                                    <td class="lableTd t_r">申报状态</td>
                                    <td colspan="3">${stdApprove.stateStr}</td>
                                  </tr>                                                                              
                                </table>
                           	  ...
                           	  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_2">
                            	  <thead>
                          	      ...
                          	      <tr>
                       	          ...
                       	          <tr>
									<td>
										<iframe id="attachGroupIframe" height="35" frameborder="0" autoheight="true" width="80%" scrolling="no" src="../attachment/findByGroup?group=${stdApprove.attachGroup}&dest_code=attachGroup&refresh=1&showHistory=1&version=${version}" ></iframe>
									</td>
								  </tr>                                   
                          	      <tr>
