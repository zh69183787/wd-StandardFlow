	...
	Weather.prototype = {
		...
		init : function(config){
			...
			var weatherInfo = this.opts.weatherData || {},
				...
				templeteHtml = '<dt><h1>{#day_temp#}{#temp#}~<font>{#night_temp#}{#temp#}</font></h1><span class="wdate">{#date#}</span><span class="wcity">{#city#}</span></dt><dd class="clearfix"><span class="fl wday">{#day#} : {#day_weather#} {#day_wind#}</span><span class="fr wnight">{#night#} : {#night_weather#} {#night_wind#}</span></dd>',
			...
			this.$element.append(templete( templeteHtml, {
					'{#city#}' : weatherInfo.city,
					'{#date#}' : weatherInfo.date,
					'{#day#}' : config.lang.day ,
					'{#day_weather#}' : weatherInfo.day_weather ,
					...
					'{#temp#}' : config.lang.temp,
					'{#day_wind#}' : weatherInfo.day_wind,
					'{#night_wind#}' : weatherInfo.night_wind,
					'{#night_weather#}' : weatherInfo.night_weather,
					'{#night#}' : config.lang.night ,
					'{#night_temp#}' : weatherInfo.night_temp 
				}));
