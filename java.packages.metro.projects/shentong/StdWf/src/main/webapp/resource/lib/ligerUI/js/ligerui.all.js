...
(function ($)
{
    ...
    $.ligerui.controls.Accordion.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _render: function ()
        {
            ...
            {
                var header = $('<div class="l-accordion-header tabmain_'+i+'"><div class="l-accordion-toggle"></div><div class="l-accordion-header-inner"></div></div>');
                if (i == selectedIndex)
...
(function ($)
{
    ...
    $.ligerui.controls.Layout.ligerExtend($.ligerui.core.UIComponent, {
        ...
        { 
            ...
            if(p.centerWidthDiff!=0){
            	 g.center.width(g.center.width()-p.centerWidthDiff);
            }
