...
(function ($)
{
    $.fn.ligerDateYearEditor = function ()
    {
        return $.ligerui.run.call(this, "ligerDateYearEditor", arguments);
    };

    $.fn.ligerGetDateYearEditorManager = function ()
    {
        return $.ligerui.run.call(this, "ligerGetDateYearEditorManager", arguments);
    };
    

    $.ligerDefaults.DateYearEditor = {
        format: "yyyy-MM-dd hh:mm",
        showTime: false,
        onChangeDate: false,
        absolute: true  //选择框是否在附加到body,并绝对定位
    };
    $.ligerDefaults.DateYearEditorString = {
        dayMessage: ["日", "一", "二", "三", "四", "五", "六"],
        monthMessage: ["一月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一月", "十二月"],
        todayMessage: "今年",
        closeMessage: "关闭"
    };
    $.ligerMethos.DateYearEditor = {};

    $.ligerui.controls.DateYearEditor = function (element, options)
    {
        $.ligerui.controls.DateYearEditor.base.constructor.call(this, element, options);
    };
    $.ligerui.controls.DateYearEditor.ligerExtend($.ligerui.controls.Input, {
        __getType: function ()
        {
        ...
        {
            return $.ligerMethos.DateYearEditor;
        },
        _render: function ()
        {
            ...
            var dateeditorHTML = "";
            dateeditorHTML += "<div class='l-box-dateeditor' style='display:none;width:120px;'>";
            ...
            dateeditorHTML += "        <div class='l-box-dateeditor-header-text'> <a  class='l-box-dateeditor-header-year'></a></div>";
          ...
          /*  dateeditorHTML += "        <table cellpadding='0' cellspacing='0' border='0' class='l-box-dateeditor-calendar'>";
           ...
           // dateeditorHTML += "        <ul class='l-box-dateeditor-minuteselector'><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li></ul>";
            ...
            dateeditorHTML += "        <div class='l-button l-button-today' style='width:35px;margin-left:5px;'></div>";
            dateeditorHTML += "        <div class='l-button l-button-close' style='width:35px;'></div>";
            ...
            *************/
            ...
            }).click(function ()
            {
                if (p.disabled) return;
                g.bulidContent();
                g.toggleDateYearEditor(g.dateeditor.is(":visible"));
            });
            //不可用属性时处理
            if (p.disabled)
            {
            ...
            g.buttons.btnYear.click(function ()
            {
              ...
              /*  if (!g.body.yearselector.is(":visible"))
            	...
            	//alert(g.currentDate.year);
            	 g.inputText.val(g.currentDate.year);
        ...
        updateSelectBoxPosition: function ()
        {
            ...
            if (p.absolute)
            {
            	var edWidth = g.dateeditor.width();
            	var bodyWidth = $('body').width();
            	var pleft = g.text.offset().left;
            	var oleft=0;
            	if(edWidth+pleft>bodyWidth-20){
            		oleft = edWidth+pleft-bodyWidth+20;
            	}
            	
            	
                g.dateeditor.css({ left: g.text.offset().left-oleft, top: g.text.offset().top + 1 + g.text.outerHeight() });
            }
            else
            {
        ...
        toggleDateYearEditor: function (isHide)
        {
            var g = this, p = this.options;
        ...
        showDate: function ()
        {
           ...
           /* var dateStr = g.selectedDate.year + "/" + g.selectedDate.month + "/" + g.selectedDate.date;
            ...
            this.inputText.val(g.selectedDate.year);
        ...
        _setWidth: function (value)
        {
            ...
            {
                g.text.css({ width: 50 });
                g.inputText.css({ width: 50 - 20 });
                g.textwrapper.css({ width: 50 });
            }
        },
